...
- **purpose**: specifies what this openmag instance is intended to accomplish as its on-going concern
- **limits**: specifies guardrails and constraints
...
openmag will bootstrap this source code project to implement a complete autonomous AI agent that can use the chosen LLM (model) for reasoning, planning, and formulating actions. openmag will be used to instantiate at least one deployment of itself for the purpose of developing improvements to its own capabilities through code changes to this source code project working in collaboration with other deployment instances of openmag or with human contributors.
